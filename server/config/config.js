...
var platformConfig = {
  development: {
    ...
    mongo: {
      url: 'mongodb://localhost:27017/package-dev'
    },
    oauth: {
      facebook: {
  ...
  test: {
    ...
    mongo: {
      url: 'mongodb://localhost:27017/package-test'
    }
  },
  ...
  production: {
    ...
    mongo: {
      url: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://localhost:27017/package'
    },
    oauth: {
      facebook: {
        clientId: '231235687068678',
